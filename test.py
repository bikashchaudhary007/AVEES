...
home = ImageTk.PhotoImage(Image.open('assets/icons/home.png').resize((40,40)))
settings = ImageTk.PhotoImage(Image.open('assets/icons/settings.png').resize((40,40)))
ring = ImageTk.PhotoImage(Image.open('assets/icons/ring.png').resize((40,40)))
